...
<head>
    ...
    <link href="assets/international-direct-dialing/select2.min.css" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="assets/international-direct-dialing/style.css?v=1" />
</head>
...
<body>
    ...
    <div class="bc">
        <div class="container">
            <div class="bc-content">
                ...
                <p>
                    Home > International Direct Dialing
                </p>
            </div>
        </div>
    </div>
            ...
            <div>
                ...
                <div class="tab-content international-roaming-content">
                    <div class="tab-pane fade <?= $filter == 'overview' ? 'show active' : '' ?> " id="overview">
                        ...
                        <p><strong>Distance ends with a call</strong>. Choose <strong>COMIUM Gambia IDD</strong> for <strong>affordable, transparent, and reliable international calls from Gambia</strong>.</p>

                        </p>
                    </div>

                    <div class="tab-pane fade <?= $filter == 'tariff' ? 'show active' : '' ?> " id="tariff">
                        <?php include_once('./assets/international-direct-dialing/tariffs.php'); ?>
                    </div>

                    <div class="tab-pane fade <?= $filter == 'complaints' ? 'show active' : '' ?> " id="complaints">
                        <?php include_once('./assets/international-direct-dialing/complaints.php'); ?>
                    </div>
                    <div class="tab-pane fade <?= $filter == 'faqs-and-troubleshooting' ? 'show active' : '' ?> " id="faqs-and-troubleshooting">
                        <?php include_once('./assets/international-direct-dialing/faqs.php'); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="assets/international-direct-dialing/select2.min.js"></script>
    <script src="assets/international-direct-dialing/script.js?v=4"></script>
