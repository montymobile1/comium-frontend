        ...
        <section id="showrooms-cards" class="py-5 bg-light">
          <div class="container">
            ...
            <style>
              ...
              #showrooms-cards .hours-box ul {
                list-style: none;
                margin: 0;
                padding: 0;
              }

              #showrooms-cards .hours-box li {
                display: flex;
                justify-content: space-between;
                gap: 0.75rem;
                font-size: 0.875rem;
              ...
              #showrooms-cards .hours-box li+li {
                margin-top: 0.35rem;
              }

              #showrooms-cards .hours-box .day {
                color: #6c757d;
                font-weight: 600;
                white-space: nowrap;
              }

              #showrooms-cards .hours-box .time {
                text-align: right;
              }

              #showrooms-cards .hours-note {
                margin-top: 0.5rem;
                font-size: 0.8rem;
                color: #6c757d;
              }
              ...
              <div class="row g-4" style="order:1;">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      ...
                      <h5 class="card-title mb-3">Airport</h5>

                      <div class="hours-box">
                        <ul>
                          <li><span class="day">Hours</span><span class="time">24/7 hours</span></li>
                        </ul>
                      </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Amdalai</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Bajakunda</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Banjul</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Bansang</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Basse</h5>

                      <div class="hours-box">
                        <ul>
                          <li><span class="day">Mon–Thu</span><span class="time">8:30am to 8:00pm</span></li>
                          <li><span class="day">Friday</span><span class="time">8:30am to 8:00pm</span></li>
                          <li><span class="day">Saturday</span><span class="time">9:00am to 5:00pm</span></li>
                          <li><span class="day">Sunday</span><span class="time">Closed</span></li>
                        </ul>
                      </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Brikama 1</h5>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                  <div class="card h-100 border-0 shadow-sm position-relative">
                    ...
                    <div class="card-body d-flex flex-column pt-4">
                      <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                      <h5 class="card-title mb-3">Brikama 2</h5>
                ...
                <div class="row g-4">
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Brikama Ba</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Farafenni 1</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Farafenni 2</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Kaur</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Sanyang</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Soma</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Wassu</h5>
                        ...
                        <div class="hours-box">
                          ...
                          <div class="hours-note">Monday opens till 7pm (Lumo)</div>
                        </div>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Sukuta</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Jabang</h5>

                        <div class="hours-box">
                          <ul>
                            <li><span class="day">Mon–Thu</span><span class="time">8:30am to 10:00pm</span></li>
                            <li><span class="day">Friday</span><span class="time">8:30am to 10:00pm</span></li>
                            <li><span class="day">Saturday</span><span class="time">9:00am to 5:00pm</span></li>
                            <li><span class="day">Sunday</span><span class="time">Closed</span></li>
                          </ul>
                        </div>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Busumbala</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        ...
                        <h5 class="card-title mb-3">HQ</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Barra</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Gunjur</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Senegambia</h5>

                        <div class="hours-box">
                          <ul>
                            <li><span class="day">Mon–Thu</span><span class="time">8:30am to 12:00am</span></li>
                            <li><span class="day">Friday</span><span class="time">8:30am to 12:00am</span></li>
                            <li><span class="day">Saturday</span><span class="time">9:00am to 12:00am</span></li>
                            <li><span class="day">Sunday</span><span class="time">10:00am to 12:00am</span></li>
                          </ul>
                        </div>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Brusubi</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Sinchu</h5>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="card h-100 border-0 shadow-sm position-relative">
                      ...
                      <div class="card-body d-flex flex-column pt-4">
                        <h6 class="text-uppercase text-muted mb-1">Showroom</h6>
                        <h5 class="card-title mb-3">Latrikunda</h5>
